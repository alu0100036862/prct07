...
describe Racional do
  ...
  describe "# test de asignaciones/inicializaciones" do	
  ...
  describe "# tests de operaciones con una sola fracción" do	
    ...
    it "Se debe calcular el valor absoluto de una fraccion con el metodo abs" do
      Racional.new(-1,3).abs.should == @fraccion1.should
    end
  ...
  describe "# tests de operaciones con dos fracciones" do	
  ...
  describe "# test de comparaciones etre fracciones" do	
